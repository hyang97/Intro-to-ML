...
class Cluster(object) :
    ...
    def centroid(self) :
        ...
        mean_attrs = np.array([p.attrs for p in self.points]).mean(axis=0)
        

        centroid = Point('centroid', cluster_label, mean_attrs)
        return centroid
        ### ========== TODO : END ========== ###
    ...
    def medoid(self) :
        ...
        for p in self.points:
            ...
            for q in self.points:
                total_distance += p.distance(q)
            min_distance[p] = total_distance
        
        medoid = min(min_distance, min_distance.get)
        return medoid
        ### ========== TODO : END ========== ###
